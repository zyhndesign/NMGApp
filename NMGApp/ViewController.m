...
- (void) setNavBtnSelectState:(BOOL)landBtnState Humanity:(BOOL)humanityBtnState Story:(BOOL)storyBtnState Community:(BOOL)communityState
{
    ...
    {
        [menuLandscapeBtn setTitleColor:[UIColor colorWithRed:37/255.0 green:194/255.0 blue:157/255.0 alpha:1] forState:UIControlStateNormal];
    ...
    {
        [menuHumanityBtn setTitleColor:[UIColor colorWithRed:37/255.0 green:194/255.0 blue:157/255.0 alpha:1] forState:UIControlStateNormal];
    ...
    {
        [menuStoryBtn setTitleColor:[UIColor colorWithRed:37/255.0 green:194/255.0 blue:157/255.0 alpha:1] forState:UIControlStateNormal];
        [menuHumanityBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [menuLandscapeBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [menuCommunityBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [menuLandscapeLabel setHidden:YES];
    ...
    {
        [menuCommunityBtn setTitleColor:[UIColor colorWithRed:37/255.0 green:194/255.0 blue:157/255.0 alpha:1] forState:UIControlStateNormal];
        [menuHumanityBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [menuStoryBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [menuLandscapeBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [menuLandscapeLabel setHidden:YES];
